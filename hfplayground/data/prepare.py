...
def denoise_development_dataset(sourcedata_dir, processed_dir, grand_mean_scale=False):
...
def gigaconnectome_development_dataset(sourcedata_dir, processed_dir, arrow_dir):
